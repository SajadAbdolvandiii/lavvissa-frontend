...
const UserIcon = () => {
  ...
  return (
    <Link to={currentUser ? "/profile" : "/login"} className="nav-user-link">
      <div className={`icon user-icon ${currentUser ? "logged-in" : ""}`}>
        {currentUser && <div className="login-indicator"></div>}
      </div>
    </Link>
  );
};
                                ...
                                <div className="picks-grid">
                                  ...
                                  <div className="pick-card">
                                    ...
                                    <div className="pick-content">
                                      ...
                                      <p className="pick-description">
                                        Mini shoulder bag with chain strap. Made
                                        of leather with silver-tone hardware.
                                      </p>
                                  ...
                                  <div className="pick-card">
                                    ...
                                    <div className="pick-content">
                                      ...
                                      <p className="pick-description">
                                        Large tote bag with handles. Made of
                                  ...
                                  <div className="pick-card">
                                    ...
                                    <div className="pick-content">
                                      ...
                                      <p className="pick-description">
                                        Leather clutch with chain strap. Made of
                                        leather with gold-tone hardware.
                                      </p>
                                  ...
                                  <div className="pick-card">
                                    ...
                                    <div className="pick-content">
                                      ...
                                      <p className="pick-description">
                                        Leather backpack with adjustable straps.
                                        Made of leather with gold-tone hardware.
                                      </p>
                                  ...
                                  <div className="testimonials-track">
                                    <div className="testimonials-column column-up">
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            ...
                                            طراحی‌ای تو ایران داریم. من که عاشق
                                            کیف‌های لاویسا شدم. هر بار که
                                            استفاده می‌کنم، همه ازم می‌پرسن از
                                            کجا خریدی؟»
                                          </p>
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «کیف آرتمیس لاویسا یه شاهکار واقعیه.
                                            من خیلی وسواسی هستم روی کیفیت و
                                            جزئیات، ولی این کیف همه انتظاراتم رو
                                            برآورده کرد. دوخت تمیز، چرم درجه یک،
                                            و طراحی خاص.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «هر کیف لاویسا یه اثر هنری منحصر به
                                            فرده. من که مجموعه‌دار کیف هستم،
                                            واقعاً از کیفیت و خلاقیت کارهاشون
                                            شگفت‌زده شدم.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «بعد از یک سال استفاده روزانه، هنوز
                                            کیفم مثل روز اول تمیز و شیکه. این
                                            نشون میده که چقدر روی کیفیت کار دقت
                                            دارن.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                    ...
                                    <div className="testimonials-column column-down">
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «طراحی کیف‌های لاویسا ترکیب
                                            هوشمندانه‌ای از سنت و مدرنیته است.
                                            هر کیف یک شاهکار هنری با هویت ایرانی
                                            است.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «من همیشه دنبال کیف‌های خاص و
                                            باکیفیت بودم. لاویسا دقیقاً همون
                                            چیزی بود که می‌خواستم. الان سه تا از
                                            کیف‌هاشون رو دارم.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «کیفیت دوخت و چرم استفاده شده در
                                            کیف‌های لاویسا فوق‌العاده‌ست. من که
                                            به عنوان یه طراح لباس خیلی به جزئیات
                                            دقت می‌کنم، واقعاً تحت تأثیر قرار
                                            گرفتم.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «به عنوان یک عکاس، همیشه دنبال
                                            لوازمی هستم که هم کاربردی باشن و هم
                                            زیبا. کیف‌های لاویسا دقیقاً همین
                                            ترکیب رو دارن. مخصوصاً برای حمل
                                    ...
                                    <div className="testimonials-column column-up">
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «وقتی میگن صنعت مد ایران داره پیشرفت
                                            می‌کنه، منظورشون برندهایی مثل
                                            لاویساست. کیفیت در سطح برندهای لوکس
                                            جهانی.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «برای من که همیشه درگیر جلسات کاری
                                            هستم، کیف‌های لاویسا هم شیک و رسمی
                                            هستن و هم عملی. واقعاً ارزش خریدشون
                                            رو داره.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «من عاشق توجه به جزئیات در کیف‌های
                                            لاویسا هستم. هر بار که یکی از
                                            کیف‌هاشون رو می‌بینم، یه چیز جدید
                                            کشف می‌کنم. این نشون میده چقدر روی
                                            طراحی وقت میذارن.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «کیف‌های لاویسا نشون میدن که چطور
                                            میشه سنت و مدرنیته رو با هم ترکیب
                                            کرد. طرح‌های سنتی ایرانی با یک نگاه
                                            مدرن، واقعاً خیره‌کننده است.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
                                      ...
                                      >
                                        <div className="testimonial-content">
                                          <p>
                                            «هر کیف لاویسا یک اثر هنری منحصر به
                                            فرده. من که مجموعه‌دار کیف هستم، از
                                            کیفیت و خلاقیت کارهاشون شگفت‌زده
                                            شدم. هر کدوم یک داستان خاص خودش رو
                                            داره.»
                                          </p>
                                          <div className="testimonial-author">
                                            <img
